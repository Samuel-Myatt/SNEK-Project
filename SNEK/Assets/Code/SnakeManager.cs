...
public class SnakeManager : MonoBehaviour
{
    ...
    void snakeMovement()
	{
        ...
        if(snakeBody.Count > 1)
		{
			...
			{
                Follow markM = snakeBody[i - 1].GetComponent<Follow>();
    ...
    void CreateBodyParts()
	{
        if(snakeBody.Count == 0)
		{
            ...
            if (!temp1.GetComponent<Follow>())
            {
                temp1.AddComponent<Follow>();
            }
        ...
        Follow markM = snakeBody[snakeBody.Count - 1].GetComponent<Follow>();
        if(countUp == 0)
		{
        ...
        if(countUp >= distanceBetween)
		{
            ...
            if (!temp.GetComponent<Follow>())
            {
                temp.AddComponent<Follow>();
            }
            ...
            snakeBody.Add(temp);
            bodyParts.RemoveAt(0);
            temp.GetComponent<Follow>().ClearMarkerList();
            countUp = 0;
        }
	}
